...
# TOOL4D=/Volumes/Development4D/4Dv20.2/tool4d.app/Contents/MacOS/tool4d
...
$FOURDCLIENT --opening-mode=interpreted --project=$PROJECT --user-param=$ACTION --headless --skip-onstartup --dataless --startup-method=GHPipeline_EntryPoint_P 
