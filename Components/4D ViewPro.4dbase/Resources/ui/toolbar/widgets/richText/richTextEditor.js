(function (global, factory) {
    ...
    var defaultActions = {
        fontFamily: {
            ...
            title: uiResource.richTextDialog.font,
            type: 'drop-down',
            specialStyle: {
                width: '120px'
            },
        ...
        fontSize: {
            ...
            '<span class="drop-down-arrow fa fa-caret-down fa-lg fa-pull-right"></span>',
            title: uiResource.richTextDialog.size,
            type: 'drop-down',
            specialStyle: {
                width: '40px'
            },
        ...
        bold: {
            ...
            title: uiResource.richTextDialog.bold,
        ...
        italic: {
            icon: '<i>I</i>',
            title: uiResource.richTextDialog.italic,
            state: function state() {
        ...
        underline: {
            icon: '<u>U</u>',
            title: uiResource.richTextDialog.underline,
            state: function state() {
        ...
        strikethrough: {
            ...
            title: uiResource.richTextDialog.strikethrough,
            state: function state() {
        ...
        colorPicker: {
            ...
            '<span class="drop-down-arrow fa fa-caret-down fa-lg fa-pull-right"></span>',
            title: uiResource.richTextDialog.colorPicker,
            type: 'drop-down',
            specialStyle: {
                width: '40px'
            },
            dropDownListId: 'textColorPicker',
            queryValue: function () {
        ...
        superScript: {
            icon: 'X<sup>2</sup>',
            title: uiResource.richTextDialog.superScript,
            state: function state() {
        ...
        subScript: {
            icon: 'X<sub>2</sub>',
            title: uiResource.richTextDialog.subScript,
            state: function state() {
